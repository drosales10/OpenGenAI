...
export const PROVIDER_DEFINITIONS = {
  ...
  local: {
    ...
    description: 'Modelos ejecutados localmente (sd.cpp, Wan2GP). Sin clave API.',
    descriptionEs: 'Modelos ejecutados localmente (sd.cpp, Wan2GP). Sin clave API.',
    fields: [],
    readOnly: true,
  },
};
...
export const MODULE_CATEGORIES = [
  {
    ...
    modules: [
      ...
      },
      {
        ...
        description: 'Text-to-video, image-to-video y video-to-video (Kling, Wan, Veo, etc.)',
        descriptionEs: 'Texto a video, imagen a video y video a video (Kling, Wan, Veo, etc.)',
        routeGroup: 'generation',
  ...
  },
  {
    ...
    modules: [
      ...
      },
      {
        ...
        description: 'Inferencia local con sd.cpp y Wan2GP (solo Electron)',
        descriptionEs: 'Inferencia local con sd.cpp y Wan2GP (solo Electron)',
        routeGroup: null,
        modelKinds: ['local'],
        providers: ['local'],
      },
